app_info = {
  "app-nz-nzejobservices-stc-preprod-aae" = {
    name                = "app-nz-nzejobservices-stc-preprod-aae"
    resource_group_name = "rg-netzero-prod-stc-preprod-aae"
    ...
    app_vnet_integration_info = {
      app_integration_network_subnet_name = "prodsh-stc-asp-subnet"
